        ...
        <div className="wfacp-template-container  ">
          ...
          >
            ...
            <section
              ...
              data-settings='{"background_background":"transparent"}'
              style={{ backgroundImage: " linear-gradient(90deg, transparent 50%, transparent 50%)" }}
            >
                                    ...
                                    >
                                      ...
                                      <div className="wfacp-comm-form-detail clearfix">
                                        <div className="wfacp-row">
                                          ...
                                          <p className="form-row form-row-wide wfacp-form-control-wrapper text-bold myGray">Contact</p>
                                          ...
                                          >
                                           ...
                                           <p className="form-row form-row-wide wfacp-form-control-wrapper text-bold myGray">Delivery</p>
                                          <p
...
<style
  dangerouslySetInnerHTML={{
    __html:
      "\n  \n\n.MiniCart_Cart_Heading {\n    font-family: 'Lato', sans-serif;\n    -webkit-font-smoothing: antialiased;\n    line-height: 30px;\n    font-size: 12px;\n    letter-spacing: 0.5px;\n    text-transform: none;\n    min-height: 73px;\n    border-bottom: none;\n    cursor: default;\n    display: flex\n;\n    flex-direction: column;\n    align-items: center;\n    justify-content: space-between;\n    position: relative;\n    background-color: white;\n}\n\n.MiniCart_Cart_CloseButton {\n    position: absolute;\n    right: 0;\n    padding: 20px 25px;\n    border: none;\n    font-family: 'Lato', sans-serif;\n    font-weight: 700;\n    font-size: 12px;\n    line-height: 15px;\n    color: #676767;\n    background-color: transparent;\n    cursor: pointer;\n    -webkit-font-smoothing: antialiased;\n    letter-spacing: 1px;\n}\n.MiniCart_Cart_CloseButtonIcon {\n    width: 15px;\n    height: 15px;\n}\n.MiniCart_Cart_CloseButtonIcon:before {\n    transform: rotate(45deg);\n} \n.MiniCart_Cart_CloseButtonIcon:before, .MiniCart_Cart_CloseButtonIcon:after {\n    display: block;\n    content: ' ';\n    border-left: 1px solid #676767;\n    position: absolute;\n    right: 50%;\n    top: 20px;\n    height: 15px;\n}\n\n.MiniCart_Cart_CloseButtonIcon:after {\n    transform: rotate(-45deg);\n} \n.MiniCart_Cart_CloseButtonIcon:before, .MiniCart_Cart_CloseButtonIcon:after {\n    display: block;\n    content: ' ';\n    border-left: 1px solid #676767;\n    position: absolute;\n    right: 50%;\n    top: 20px;\n    height: 15px;\n}\n\n\n\n.elementor-20120 .elementor-element.elementor-element-f1c046e:not(.elementor-motion-effects-element-type-background) > .elementor-widget-wrap, .elementor-20120 .elementor-element.elementor-element-f1c046e > .elementor-widget-wrap > .elementor-motion-effects-container > .elementor-motion-effects-layer {\n    background-color: transparent !important;\n}\n\n\n.button, button, input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"] {\n    font-family: \"Inter\";\n    font-size: 16px;\n    line-height: 28px;\n    font-weight: 500;\n    color: initial !important;\n    background-color: transparent !important;\n    padding: 9px 36px;\n    border-radius: 30px;\n    display: inline-block;\n    -webkit-appearance: none;\n    transition: all \nease 0.3s;\n    white-space: nowrap;\n}\n"
  }}
/>
<style
  dangerouslySetInnerHTML={{
