            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/health.shop.lebanon/"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/profile.php?id=61565442562677"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myWhite">
                                    All rights reserved © {(new Date().getFullYear())} Health Shop
                                </span>
                            </div>
                        </div>
                    </div>
